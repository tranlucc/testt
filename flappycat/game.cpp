...
bool game::initGraphic()
{
	...
	else
	{
		...
		gWindow = SDL_CreateWindow( "Flappy Cat", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN );
...
{
	LTexture image;
	image.Load("res/image/message1.png", 1);
